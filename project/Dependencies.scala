import play.sbt.PlayImport.{cache, jdbc, ws}
import sbt._
...
object Dependencies {
  ...
  private val dispatch = "net.databinder.dispatch" %% "dispatch-core" % "0.11.3"
  private val elasticSearch = "org.elasticsearch" % "elasticsearch" % "2.3.1"
  ...
  private val json4sJackson = "org.json4s" %% "json4s-jackson" % "3.2.11"
  private val json4sExt = "org.json4s" %% "json4s-ext" % "3.2.11"
